...
import MaturityDateAdmin from '../components/MaturityDateAdmin';
    ...
    <Layout style={layoutStyles}>
      <Sider width={200} theme="dark" style={sidebarStyles}>
        ...
        <Menu theme="dark" mode="inline" defaultSelectedKeys={['profile']} onClick={handleMenuItemClick}>
          ...
          <Item key="menu2" icon={<CheckOutlined />}>
            Withdrawal Request
          </Item>
          <Item key="menu3" icon={<EyeOutlined  />}>
          View Maturity Plans
          </Item>
          <Item key="menu4" icon={<CheckCircleOutlined/>}>
          Resolve Issues
          </Item>
      ...
      <Layout style={contentStyles}>
        <Header style={headerStyles}>
          <h1 style={textCenterStyles}>Manager Dashboard</h1>
        </Header>
        <Content style={{ background: 'dark', padding: '16px', color: 'white' }}>
          {selectedSection === 'profile' &&  <ProfileAdminPage/>}
          {selectedSection === 'menu1' && <ManageUserAccounts/>}
          {selectedSection === 'menu2' && <PensionStatusPage/>}
          {selectedSection === 'menu3' && <MaturityDateAdmin/>}
          {selectedSection === 'menu4' && <ResolveIssues/>}
          ...
          {selectedSection === '' && (
            <div>
              <Header style={headerStyles}>
                <h1 style={textCenterStyles}>Welcome to Manager Dashboard</h1>
              </Header>
              <img
